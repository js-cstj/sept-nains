export default class App {
    static load() {
        ...
        dormeur.addEventListener("click", e => {
            if (e.target.classList.contains("petit")) {
                e.target.classList.remove("petit");
                e.target.classList.add("grand");
            } else if (e.target.classList.contains("grand")) {
                e.target.classList.remove("grand");
            } else {
                e.target.classList.add("petit");
            }
        });
        //===========================================================
        // TIMIDE
